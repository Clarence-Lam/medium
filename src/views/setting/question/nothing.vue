<template>
  <div class="app-container">
    <h3 class="app-container-title">问答代写配置</h3>
    ...
    <div class="nothing-box">
      ...
      <div class="nothing-inline">
        ...
        <div v-if="numVisible" class="nothing-add-box">
          ...
          -
          <el-input v-model="moneyValue" placeholder="金额" style="width:130px" oninput="value=value.replace(/[^\d.]/g,'')" size="mini" @keyup.enter.native="addNum">
